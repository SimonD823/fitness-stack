...
Remote (iPhone/iPad)
    ...
    └── Tailscale VPN
            ...
            └── NAS (always on)
                  ...
                  ├── daily-brief         ← coaching emails (06:45 AM + Mon 02:00 AM)
                  └── open-webui :3001    ← chat UI → Max Ollama
                                                  │
                                          Max (on demand)
                                          └── Ollama :11434
                                              └── Qwen3.6-27B
...
| Minisforum MS-S1 Max | Max — Ollama, Qwen3.6-27B inference | `max` |
...
| `cronometer-sync` | `cronometer-sync` | 06:00 AM daily | Cronometer → InfluxDB (CronometerStats) |
| `daily-brief` | `daily-brief` | 06:45 AM daily + Mon 02:00 AM | Daily coaching email + weekly training report |
...
| [04-ollama-qwen.md](docs/04-ollama-qwen.md) | Ollama + Qwen3.6-27B + thinking mode |
...
| [07-coaching-emails-guide.md](docs/07-coaching-emails-guide.md) | Daily + weekly coaching email setup |
